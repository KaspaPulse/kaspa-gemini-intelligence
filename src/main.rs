...
async fn main() -> anyhow::Result<()> {
    ...
    // Initializing high-performance wRPC client for Kaspa v1.1.0
    let rpc_client = KaspaRpcClient::new(WrpcEncoding::Borsh, Some(&ws_url), None, None, None)?;
    ...
    let handler = Update::filter_message()
        ...
        .branch(
            dptree::entry()
                ...
                .endpoint(crate::ai::process_voice_intent),
        )
